---
description: Prove a native audio plug-in against the full Mercurial Tones compatibility and resilience regression catalog
argument-hint: [repository-path]
---

Invoke the `checklist` skill for `$ARGUMENTS`. If no repository path was supplied, audit the current working directory.
...
Before replacing any plug-in bundle, prove every target DAW/scanner/Standalone process is closed. Post-install host evidence must come from a newly launched process whose start time is later than bundle replacement.
